...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/main.server.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var DIST_BROWSER_FOLDER = path_1.resolve(__dirname, '..', 'browser');
var INDEX_HTML_PATH = path_1.join(DIST_BROWSER_FOLDER, 'index.html');
// Our index.html we'll use as our template
var INDEX_HTML = fs_1.readFileSync(INDEX_HTML_PATH).toString();
// * NOTE :: leave this as require() since this file is built Dynamically from webpack
var _a = __webpack_require__(/*! ../src/app/ngmodule */ "./src/app/ngmodule.ts"), AppServerModule = _a.AppServerModule, AppServerModuleNgFactory = _a.AppServerModuleNgFactory, LAZY_MODULE_MAP = _a.LAZY_MODULE_MAP;
exports.api.engine('html', function (_, options, callback) {
    platform_server_1.renderModuleFactory(AppServerModuleNgFactory || AppServerModule, {
        // Our index.html
        document: INDEX_HTML,
        url: options.req.url,
...
exports.api.set('view engine', 'html');
exports.api.set('views', DIST_BROWSER_FOLDER);
// Server static files from /browser
exports.api.get('*.*', express.static(DIST_BROWSER_FOLDER));
// All regular routes use the Universal engine
exports.api.get('*', function (req, res) {
    res.render(INDEX_HTML_PATH, { req: req });
});
...
Object.defineProperty(exports, "__esModule", { value: true });
var express_config_1 = __webpack_require__(/*! ./express-config */ "./server/config/express-config.ts");
...
var AppConfig = /** @class */ (function () {
    ...
    AppConfig.prototype.includeConfig = function () {
        this.app.use(bodyParser.json());
        this.app.use(cors());
        var EC = new express_config_1.ExpressConfig(this.app);
    };
    return AppConfig;
}());
...
module.exports.EMAIL_AVAILABLE_FAILED = "Email is unavailable.";
...
module.exports.USER_LOGIN_PASSWORD_FAILED = "Wrong password.";
...
var Db = /** @class */ (function () {
    ...
    Db.prototype.onConnect = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.mongoClient.connect(mongoURL, function (err, db) {
                if (err) {
                    reject(err);
                }
                else {
                    assert.equal(null, err);
                    resolve([db, _this.ObjectID]);
                }
            });
        });
    };
...
/***/ "./server/config/express-config.ts":
/*!*****************************************!*\
  !*** ./server/config/express-config.ts ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./server/handlers/query-handler.ts":
/*!******************************************!*\
  !*** ./server/handlers/query-handler.ts ***!
  \******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var db_1 = __webpack_require__(/*! ./../config/db */ "./server/config/db.ts");
var QueryHandler = /** @class */ (function () {
    function QueryHandler() {
        this.Mongodb = new db_1.Db;
    }
    QueryHandler.prototype.userNameCheck = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _a, DB_1, ObjectID, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_1 = _a[0], ObjectID = _a[1];
                        DB_1.collection('users').find(data).count(function (error, result) {
                            DB_1.close();
                            if (error) {
                                reject(error);
                            }
    ...
    QueryHandler.prototype.getUserByUsername = function (username) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _a, DB_2, ObjectID, error_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_2 = _a[0], ObjectID = _a[1];
                        DB_2.collection('users').find({
                            username: username
    ...
    QueryHandler.prototype.getUserByEmail = function (email) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _a, DB_3, ObjectID, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_3 = _a[0], ObjectID = _a[1];
                        DB_3.collection('users').find({
                            email: email
                        }).toArray(function (error, result) {
                            DB_3.close();
                            if (error) {
    ...
    QueryHandler.prototype.makeUserOnline = function (userId) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _a, DB_4, ObjectID, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_4 = _a[0], ObjectID = _a[1];
                        DB_4.collection('users').findAndModify({
                            _id: ObjectID(userId)
                        }, [], { '$set': { 'online': 'Y' } }, { new: true, upsert: true }, function (err, result) {
                            DB_4.close();
                            if (err) {
                                reject(err);
                            }
    ...
    QueryHandler.prototype.registerUser = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _a, DB_5, ObjectID, error_5;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_5 = _a[0], ObjectID = _a[1];
                        DB_5.collection('users').insertOne(data, function (err, result) {
                            DB_5.close();
                            if (err) {
                                reject(err);
                            }
    ...
    QueryHandler.prototype.userSessionCheck = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _a, DB_6, ObjectID, error_6;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_6 = _a[0], ObjectID = _a[1];
                        DB_6.collection('users').findOne({ _id: ObjectID(data.userId), online: 'Y' }, function (err, result) {
                            DB_6.close();
                            if (err) {
                                reject(err);
                            }
    ...
    QueryHandler.prototype.getUserInfo = function (_a) {
        var _this = this;
        var userId = _a.userId, _b = _a.socketId, socketId = _b === void 0 ? false : _b;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_7 = _a[0], ObjectID = _a[1];
                        DB_7.collection('users').aggregate([{
                                $match: {
                                    _id: ObjectID(userId)
                                }
                            }, {
    ...
    QueryHandler.prototype.addSocketId = function (_a) {
        var _this = this;
        var userId = _a.userId, socketId = _a.socketId;
        var data = {
            id: userId,
            value: {
                $set: {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_8 = _a[0], ObjectID = _a[1];
                        DB_8.collection('users').update({ _id: ObjectID(data.id) }, data.value, function (err, result) {
                            DB_8.close();
                            if (err) {
                                reject(err);
                            }
    ...
    QueryHandler.prototype.getChatList = function (socketId) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _a, DB_9, ObjectID, error_9;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_9 = _a[0], ObjectID = _a[1];
                        DB_9.collection('users').aggregate([{
                                $match: {
    ...
    QueryHandler.prototype.insertMessages = function (messagePacket) {
        var _this = this;
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _a, DB_10, ObjectID, error_10;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_10 = _a[0], ObjectID = _a[1];
                        DB_10.collection('messages').insertOne(messagePacket, function (err, result) {
                            DB_10.close();
                            if (err) {
                                reject(err);
                            }
    ...
    QueryHandler.prototype.getMessages = function (_a) {
        var _this = this;
        var userId = _a.userId, toUserId = _a.toUserId;
        var data = {
            '$or': [
                {
                    '$and': [
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _a, DB_11, ObjectID, error_11;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_11 = _a[0], ObjectID = _a[1];
                        DB_11.collection('messages').find(data).sort({ 'timestamp': 1 }).toArray(function (err, result) {
                            DB_11.close();
                            if (err) {
                                reject(err);
                            }
    ...
    QueryHandler.prototype.logout = function (userID, isSocketId) {
        var _this = this;
        var data = {
            $set: {
                online: 'N'
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var _a, DB_12, ObjectID, condition, error_12;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.Mongodb.onConnect()];
                    case 1:
                        _a = _b.sent(), DB_12 = _a[0], ObjectID = _a[1];
                        condition = {};
                        if (isSocketId) {
                        ...
                        DB_12.collection('users').update(condition, data, function (err, result) {
                            DB_12.close();
                            if (err) {
                                reject(err);
                            }
...
/***/ "./server/handlers/route-handler.ts":
/*!******************************************!*\
  !*** ./server/handlers/route-handler.ts ***!
  \******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var jwt_1 = __webpack_require__(/*! ../utils/jwt */ "./server/utils/jwt.ts");
var CONSTANTS = __webpack_require__(/*! ./../config/constants */ "./server/config/constants.ts");
var password_hash_1 = __webpack_require__(/*! ./../utils/password-hash */ "./server/utils/password-hash.ts");
var query_handler_1 = __webpack_require__(/*! ./query-handler */ "./server/handlers/query-handler.ts");
var RouteHandler = /** @class */ (function () {
    function RouteHandler() {
    }
    RouteHandler.prototype.userNameCheckHandler = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var passwordHash, queryHandler, username, count, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        passwordHash = new password_hash_1.PasswordHash();
                        queryHandler = new query_handler_1.QueryHandler();
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, queryHandler.userNameCheck({
    ...
    RouteHandler.prototype.registerRouteHandler = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var passwordHash, jwt, queryHandler, data, count, result, dataObj, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        passwordHash = new password_hash_1.PasswordHash();
                        jwt = new jwt_1.JWToken();
                        queryHandler = new query_handler_1.QueryHandler();
                        data = {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 8];
                    case 2:
                        if (!!data.username) return [3 /*break*/, 3];
                        response.status(CONSTANTS.SERVER_ERROR_HTTP_CODE).json({
                            error: true,
                            message: CONSTANTS.USERNAME_NOT_FOUND
                        });
                        return [3 /*break*/, 8];
                    case 3:
                        if (!!data.password) return [3 /*break*/, 4];
                        response.status(CONSTANTS.SERVER_ERROR_HTTP_CODE).json({
                            error: true,
                        ...
                        return [3 /*break*/, 8];
                    case 4:
                        if (!!data.email) return [3 /*break*/, 5];
                        response.status(CONSTANTS.SERVER_ERROR_HTTP_CODE).json({
                            error: true,
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, queryHandler.registerUser(data)];
                    case 6:
                        result = _a.sent();
    ...
    RouteHandler.prototype.loginRouteHandler = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var passwordHash, jwt, queryHandler, data, result, dataObj, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        passwordHash = new password_hash_1.PasswordHash();
                        ...
                        if (!(data.email === '' || data.email === null)) return [3 /*break*/, 1];
                        response.status(CONSTANTS.SERVER_ERROR_HTTP_CODE).json({
                            error: true,
                            message: CONSTANTS.USERNAME_NOT_FOUND
                        });
                        return [3 /*break*/, 9];
                    case 1:
                        if (!(data.password === '' || data.password === null)) return [3 /*break*/, 2];
                        response.status(CONSTANTS.SERVER_ERROR_HTTP_CODE).json({
                            error: true,
                            message: CONSTANTS.PASSWORD_NOT_FOUND
                        });
                    ...
                    case 2:
                        _a.trys.push([2, 8, , 9]);
                        return [4 /*yield*/, queryHandler.getUserByEmail(data.email)];
                    case 3:
                        result = _a.sent();
                        ...
                        return [3 /*break*/, 7];
                    case 4:
                        if (!passwordHash.compareHash(data.password, result.password)) return [3 /*break*/, 6];
                        return [4 /*yield*/, queryHandler.makeUserOnline(result._id)];
                    case 5:
                        _a.sent();
                        dataObj = {
                            id: result._id,
    ...
    RouteHandler.prototype.getMessagesRouteHandler = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var queryHandler, userId, toUserId, messagesResponse, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        queryHandler = new query_handler_1.QueryHandler();
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, queryHandler.getMessages({
                                userId: userId,
                                toUserId: toUserId
                            })];
                    case 2:
...
var JWToken = /** @class */ (function () {
    function JWToken() {
        this.secret = process.env.DB_URL;
    }
    JWToken.prototype.encodeToken = function (data) {
        var tokenObj = {
...
var PasswordHash = /** @class */ (function () {
    ...
    PasswordHash.prototype.createHash = function (password) {
        return bcrypt.hashSync(password, 10);
    };
    PasswordHash.prototype.compareHash = function (password, hash) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var route_handler_1 = __webpack_require__(/*! ../handlers/route-handler */ "./server/handlers/route-handler.ts");
var Routes = /** @class */ (function () {
    function Routes(app) {
        this.app = app;
        this.routeHandler = new route_handler_1.RouteHandler();
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var query_handler_1 = __webpack_require__(/*! ../handlers/query-handler */ "./server/handlers/query-handler.ts");
var CONSTANTS = __webpack_require__(/*! ./../config/constants */ "./server/config/constants.ts");
var Socket = /** @class */ (function () {
    function Socket(socket) {
        this.io = socket;
        this.queryHandler = new query_handler_1.QueryHandler();
    }
    Socket.prototype.socketEvents = function () {
        var _this = this;
        this.io.on('connection', function (socket) {
            /* Get the user's Chat list	*/
            socket.on("chat-list", function (data) { return __awaiter(_this, void 0, void 0, function () {
                var _a, UserInfoResponse, chatlistResponse, error_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!!data.userId) return [3 /*break*/, 1];
                        ...
                        case 2:
                            _a = _b.sent(), UserInfoResponse = _a[0], chatlistResponse = _a[1];
            ...
            socket.on("message-broadcast", function (data) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    try {
            ...
            socket.on("add-message", function (data) { return __awaiter(_this, void 0, void 0, function () {
                var _a, toSocketId, messageResult, error_2;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!(data.message === '')) return [3 /*break*/, 1];
                            ...
                            return [3 /*break*/, 6];
                        case 1:
                            if (!(data.fromUserId === '')) return [3 /*break*/, 2];
                            this.io.to(socket.id).emit("add-message-response", {
                                error: true,
                                message: CONSTANTS.SERVER_ERROR_MESSAGE
                            });
                            return [3 /*break*/, 6];
                        case 2:
                            if (!(data.toUserId === '')) return [3 /*break*/, 3];
                            this.io.to(socket.id).emit("add-message-response", {
                                error: true,
                        ...
                        case 4:
                            _a = _b.sent(), toSocketId = _a[0], messageResult = _a[1];
            ...
            socket.on("drawing", function (data) { return __awaiter(_this, void 0, void 0, function () {
                var toSocketId, error_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(data.fromUserId === '')) return [3 /*break*/, 1];
                            ...
                            return [3 /*break*/, 5];
                        case 1:
                            if (!(data.toUserId === '')) return [3 /*break*/, 2];
                            this.io.to(socket.id).emit("new-drawing", {
                                error: true,
                                message: CONSTANTS.SELECT_USER
                            });
            ...
            socket.on("clear-whiteboard", function (data) { return __awaiter(_this, void 0, void 0, function () {
                var toSocketId, error_4;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(data.fromUserId === '')) return [3 /*break*/, 1];
            ...
            socket.on("start-typing", function (data) { return __awaiter(_this, void 0, void 0, function () {
                var toSocketId, error_5;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(data.fromUserId === '')) return [3 /*break*/, 1];
             ...
             * Logout the user
             */
            socket.on('logout', function (data) { return __awaiter(_this, void 0, void 0, function () {
                var userId, error_6;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.queryHandler.logout(userId)];
                        case 2:
                            _a.sent();
            ...
            socket.on('start-video-chat', function (data) { return __awaiter(_this, void 0, void 0, function () {
                var toSocketId, error_7;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
            ...
            socket.on('offer', function (data) { return __awaiter(_this, void 0, void 0, function () {
                var toSocketId, error_8;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
            ...
            socket.on('answer', function (data) { return __awaiter(_this, void 0, void 0, function () {
                var toSocketId, error_9;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
            ...
            socket.on('hang-up', function (data) { return __awaiter(_this, void 0, void 0, function () {
                var toSocketId, error_11;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
        ...
        this.io.use(function (socket, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.queryHandler.addSocketId({
                                userId: socket.request._query['userId'],
                                socketId: socket.id
                            })];
                    case 1:
...
var Constant = /** @class */ (function () {
    ...
    /*  public static API_URL = 'http://192.168.0.218:4000/';
      public static SOCKET_URL = 'http://192.168.0.218:4000/';*/
...
var app_config_1 = __webpack_require__(/*! ../server/config/app-config */ "./server/config/app-config.ts");
var api_1 = __webpack_require__(/*! ../server/api */ "./server/api.ts");
var Server = /** @class */ (function () {
    function Server() {
        // Faster server renders w/ Prod mode (dev mode never needed)
        core_1.enableProdMode();
        this.http = new http.Server(api_1.api);
        this.socket = socketio(this.http);
    }
    Server.prototype.appConfig = function () {
        new app_config_1.AppConfig(api_1.api).includeConfig();
    };
    /* Including app Routes starts*/
    Server.prototype.includeRoutes = function () {
        new routes_1.Routes(api_1.api).routesConfig();
        new socket_1.Socket(this.socket).socketConfig();
    };
